...
public class PreffixCalculatorParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, Integer=5, NEWLINE=6, WS=7, COMMENT=8;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, "Integer", "NEWLINE", "WS", "COMMENT"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3) | (1L << Integer) | (1L << NEWLINE))) != 0)) {
				{
				{
				setState(6);
				stat();
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3) | (1L << Integer))) != 0)) {
				{
				setState(14);
				expr();
				}
	...
	public static class ExprCalcContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PreffixCalculatorListener ) ((PreffixCalculatorListener)listener).enterExprCalc(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PreffixCalculatorListener ) ((PreffixCalculatorListener)listener).exitExprCalc(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PreffixCalculatorVisitor ) return ((PreffixCalculatorVisitor<? extends T>)visitor).visitExprCalc(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExprIntegerContext extends ExprContext {
		public TerminalNode Integer() { return getToken(PreffixCalculatorParser.Integer, 0); }
		public ExprIntegerContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PreffixCalculatorListener ) ((PreffixCalculatorListener)listener).enterExprInteger(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PreffixCalculatorListener ) ((PreffixCalculatorListener)listener).exitExprInteger(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PreffixCalculatorVisitor ) return ((PreffixCalculatorVisitor<? extends T>)visitor).visitExprInteger(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case T__3:
				...
				setState(20);
				((ExprCalcContext)_localctx).op1 = expr();
				setState(21);
				((ExprCalcContext)_localctx).op2 = expr();
				}
				break;
			case Integer:
